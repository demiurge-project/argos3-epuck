...
# Vision sources
#
set(ARGOS3_CLIENT_SOURCES_PLUGINS_ROBOTS_XPUCK_REALROBOT_VISION
  ${ARGOS3_HEADERS_PLUGINS_ROBOTS_XPUCK_REALROBOT_VISION}
  ${ARGOS3_MOC_SOURCE_PLUGINS_ROBOTS_XPUCK_REALROBOT_VISION}
  real_robot/vision/xpuck_camera_client_blob_detector_configurator.cpp
  real_robot/vision/xpuck_camera_client_image_grabber_configurator.cpp
  real_robot/vision/xpuck_camera_client_distance_converter_configurator.cpp
  real_robot/vision/xpuck_camera_client_main_window.cpp
...
# Create target
#
add_executable(xpuck_camera_configurator_client
  ${ARGOS3_CLIENT_SOURCES_PLUGINS_ROBOTS_XPUCK_REALROBOT_VISION})

target_link_libraries(xpuck_camera_configurator_client
