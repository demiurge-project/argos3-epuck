/**
 * @file <argos3/plugins/robots/x-puck/simulator/xpuck_rab_equipped_entity.cpp>
 *
 * @author Gianpiero Francesca <gianpiero.francesca@ulb.ac.be>
 * @author Lorenzo Garattoni <lgaratto@ulb.ac.be>
 */

#include "xpuck_rab_equipped_entity.h"
...
CXpuckRABEquippedEntity::CXpuckRABEquippedEntity(CComposableEntity* pc_parent) :
...
CCI_XPuckRangeAndBearingActuator::SEmitter& CXpuckRABEquippedEntity::GetEmitterForAngle(const CRadians& t_angle) {
    /**
...
void CXpuckRABEquippedEntity::Reset() {
    m_cEmitterData=CCI_XPuckRangeAndBearingActuator::SDataToSend();
}

/****************************************/
/****************************************/

void CXpuckRABEquippedEntity::SetDataToSend(const CCI_XPuckRangeAndBearingActuator::SDataToSend& c_data) {
...
void CXpuckRABEquippedEntity::ClearData() {
    m_cEmitterData=CCI_XPuckRangeAndBearingActuator::SDataToSend();
}
...
void CXpuckRABEquippedEntitySpaceHashUpdater::operator()(CAbstractSpaceHash<CXpuckRABEquippedEntity>& c_space_hash,
...
REGISTER_STANDARD_SPACE_OPERATIONS_ON_ENTITY(CXpuckRABEquippedEntity);

/****************************************/
/****************************************/

CXpuckRABEquippedEntityGridCellUpdater::CXpuckRABEquippedEntityGridCellUpdater(CGrid<CXpuckRABEquippedEntity>& c_grid) :
    m_cGrid(c_grid) {}

bool CXpuckRABEquippedEntityGridCellUpdater::operator()(SInt32 n_i,
                                                        SInt32 n_j,
                                                        SInt32 n_k,
...
void CXpuckRABEquippedEntityGridCellUpdater::SetEntity(CXpuckRABEquippedEntity& c_entity) {
    m_pcEntity = &c_entity;
}

CXpuckRABEquippedEntityGridEntityUpdater::CXpuckRABEquippedEntityGridEntityUpdater(CGrid<CXpuckRABEquippedEntity>& c_grid) :
    m_cGrid(c_grid),
    m_cCellUpdater(c_grid) {}

bool CXpuckRABEquippedEntityGridEntityUpdater::operator()(CXpuckRABEquippedEntity& c_entity) {
    try {
