/**
 * @file <argos3/plugins/robots/x-puck/simulator/xpuck_ground_default_sensor.cpp>
 *
...
#include "xpuck_ground_rotzonly_sensor.h"
...
namespace argos {
   ...
   CXPuckGroundRotZOnlySensor::CXPuckGroundRotZOnlySensor() :
   ...
   void CXPuckGroundRotZOnlySensor::SetRobot(CComposableEntity& c_entity) {
   ...
   void CXPuckGroundRotZOnlySensor::Init(TConfigurationNode& t_tree) {
      try {
         CCI_XPuckGroundSensor::Init(t_tree);
         /* Parse noise level */
   ...
   void CXPuckGroundRotZOnlySensor::Update() {
      /*
   ...
   void CXPuckGroundRotZOnlySensor::Reset() {
      for(UInt32 i = 0; i < 3; ++i) {
         m_sReadings[i] = 0.0f;
      }
   }
   ...
   REGISTER_SENSOR(CXPuckGroundRotZOnlySensor,
                   "xpuck_ground", "rot_z_only",
                   "Lorenzo Garattoni [lgaratto@ulb.ac.be]",
                   "1.0",
                   "The x-puck ground sensor",
                   ...
                   "For usage, refer to [ci_xpuck_ground_sensor.h]\n\n"
                   ...
                   "         <sensors>\n"
                   "            ...\n"
                   "            <xpuck_ground implementation=\"rot_z_only\"/>\n"
                   "            ...\n"
                   "         <sensors/>\n"
                   "         ...\n"
                   "      <my_controller/>\n"
                   ...
                   "         <sensors>\n"
                   "            ...\n"
                   "            <xpuck_ground implementation=\"rot_z_only\" noise_level=\"0.1\"/>\n"
                   "            ...\n"
                   "         <sensors/>\n"
                   "         ...\n"
                   "      <my_controller/>\n"
