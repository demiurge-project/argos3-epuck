/**
 * @file <argos3/plugins/robots/x-puck/simulator/xpuck_virtual_camrab_default_actuator.cpp>
 *
 * @author Antoine Ligot - <aligot@ulb.ac.be>
 */

#include "xpuck_virtual_camrab_default_actuator.h"
...
namespace argos {
    ...
    void CXPuckVirtualCamrabDefaultActuator::SetRobot(CComposableEntity& c_entity) {
    ...
    void CXPuckVirtualCamrabDefaultActuator::Init(TConfigurationNode& t_tree) {
        CCI_XPuckVirtualCamrabActuator::Init(t_tree);
    }

    /****************************************/
    /****************************************/

    void CXPuckVirtualCamrabDefaultActuator::Update() {
        CCI_XPuckRangeAndBearingActuator::SDataToSend dataToSend;
        dataToSend.State = (CCI_XPuckRangeAndBearingActuator::EEmitterState)(m_sDesiredData.State); 
...
REGISTER_ACTUATOR(CXPuckVirtualCamrabDefaultActuator,
                  "xpuck_virtual_camrab", "default",
                  "Antoine Ligot - [aligot@ulb.ac.be]"
                  ,
                  "1.0",
                  "The camrab actuator of the x-puck.",
                  "This actuator allows xpucks to perform improved situated communication. \n"
                  ...
                  "For usage, refer to [ci_xpuck_virtual_camrab_actuator.h]\n\n"
                  ...
                  "         <actuators>\n"
                  "            ...\n"
                  "            <xpuck_range_and_bearing implementation=\"medium\" medium=\"rab\" range=\"0.8\" data_size=\"2\"/>\n"
                  "            <xpuck_rgb_leds implementation=\"default\" medium=\"leds\"/>\n"
                  "            <xpuck_virtual_camrab implementation=\"default\" number_colors=\"4\" data_size=\"2\"/> \n"
                  "            ...\n"
                  "         <actuators/>\n"
                  "         ...\n"
                  "      <my_controller/>\n"
