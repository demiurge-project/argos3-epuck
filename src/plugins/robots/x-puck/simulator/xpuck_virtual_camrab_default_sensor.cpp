/**
 * @file <argos3/plugins/robots/x-puck/simulator/xpuck_virtual_camrab_default_sensor.cpp>
 *
 * @author Antoine Ligot - <aligot@ulb.ac.be>
 */

#include "xpuck_virtual_camrab_default_sensor.h"
...
namespace argos{
    ...
    void CXPuckVirtualCamrabDefaultSensor::SetRobot(CComposableEntity& c_entity) {
        m_pcRangeAndBearingEquippedEntity = &c_entity.GetComponent<CXpuckRABEquippedEntity>("rab[rab_0]");
        ...
        m_pcRabSensor = m_pcControllableEntity->GetController().GetSensor<CCI_XPuckRangeAndBearingSensor>("xpuck_range_and_bearing");
        m_pcCamera = m_pcControllableEntity->GetController().GetSensor<CCI_XPuckOmnidirectionalCameraSensor>("xpuck_omnidirectional_camera");
        m_pcCamera->Enable();
    }
    ...
    void CXPuckVirtualCamrabDefaultSensor::Init(TConfigurationNode& t_tree) {
        CCI_XPuckVirtualCamrabSensor::Init(t_tree);
    }

    /****************************************/
    /****************************************/

    void CXPuckVirtualCamrabDefaultSensor::Reset() {
        ClearReadings();
    }
    ...
    void CXPuckVirtualCamrabDefaultSensor::Destroy() {
        ClearReadings();
    }
    ...
    void CXPuckVirtualCamrabDefaultSensor::Update() {
        std::vector<CCI_XPuckRangeAndBearingSensor::SReceivedPacket*> vecRabPackets = m_pcRabSensor->GetPackets();
        
        const CCI_XPuckOmnidirectionalCameraSensor::SReadings* sCameraReadings = &m_pcCamera->GetReadings();
        std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> vecAllBlobs = sCameraReadings->BlobList;
        
        std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> vecFilteredBlobs = FilterBlobs(vecAllBlobs);
    ...
    void CXPuckVirtualCamrabDefaultSensor::InferRobots(std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> vec_blobs, std::vector<CCI_XPuckRangeAndBearingSensor::SReceivedPacket*> vec_packets) {
        if ((!vec_blobs.empty()) && (!vec_packets.empty())) {
            ...
            for (std::vector<CCI_XPuckRangeAndBearingSensor::SReceivedPacket*>::iterator itRAB = vec_packets.begin(); itRAB != vec_packets.end(); ++itRAB) {
                ...
                Real fMinDiff = 1000;
                CCI_XPuckOmnidirectionalCameraSensor::SBlob* psElected = NULL;
    ...
    void CXPuckVirtualCamrabDefaultSensor::CreateReading(CCI_XPuckOmnidirectionalCameraSensor::SBlob* ps_blob, CCI_XPuckRangeAndBearingSensor::SReceivedPacket* ps_RAB_packet) {
    ...
    void CXPuckVirtualCamrabDefaultSensor::CreateReading(CCI_XPuckRangeAndBearingSensor::SReceivedPacket* ps_RAB_packet) {
        SReading* sNewReading = new SReading();
...
REGISTER_SENSOR(CXPuckVirtualCamrabDefaultSensor,
                "xpuck_virtual_camrab", "default",
                "Antoine Ligot - [aligot@ulb.ac.be]",
                "1.0",
                "The virtual camrab sensor of the x-puck.",
                "This sensor allows xpucks to perform improved situated communication.\n"
                ...
                "For use, refer to [ci_xpuck_virtual_camrab_sensor.h].\n\n"
                ...
                "         <sensors>\n"
                "            ...\n"
                "            <xpuck_range_and_bearing implementation=\"medium\" medium=\"rab\" show_rays=\"false\" data_size=\"2\" noise_std_dev=\"0.0\" real_range_noise=\"false\" max_packets=\"UINT32_MAX\" loss_probability=\"0.0\"/>\n"
                "            <xpuck_omnidirectional_camera implementation=\"rot_z_only\" medium=\"leds\" show_rays=\"false\" calibrated=\"true\" low_level_config=\"omnidirectional_camera_sensor.xml\"/> \n"
                "            <xpuck_virtual_camrab implementation=\"default\" number_colors=\"4\"/>\n"
                "            ...\n"
                "         <sensors/>\n"
                "         ...\n"
                "      <my_controller/>\n"
                ...
                "go check [xpuck_range_and_bearing_default_sensor.cpp] or [xpuck_omnidirectional_camera_sensor.cpp] \n"
                "\n"
                ...
                "coincide with the data_size value of the xpuck_range_and_bearing sensor. \n"
                "\n"
                "   <media>\n"
                "      ...\n"
