...
#include "xpuck_range_and_bearing_default_actuator.h"
...
void CXPuckRABDefaultActuator::SetRobot(CComposableEntity& c_entity) {
...
void CXPuckRABDefaultActuator::Init(TConfigurationNode& t_tree) {
    CCI_XPuckRangeAndBearingActuator::Init(t_tree);
    Real fRange=0.8f;
...
void CXPuckRABDefaultActuator::Update() {
...
REGISTER_ACTUATOR(CXPuckRABDefaultActuator,
                  ...
                  "For usage, refer to [ci_xpuck_range_and_bearing_actuator.h]\n\n"
                  ...
                  "         <actuators>\n"
                  "            ...\n"
                  "            <xpuck_range_and_bearing implementation=\"medium\" medium=\"rab\" range=\"0.8\"/>\n"
                  "            ...\n"
                  "         <actuators/>\n"
                  "         ...\n"
                  "      <my_controller/>\n"
