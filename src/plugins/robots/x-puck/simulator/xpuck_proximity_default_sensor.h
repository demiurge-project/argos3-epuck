/**
 * @file <argos3/plugins/robots/x-puck/simulator/x-puck_proximity_default_sensor.h>
 *
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 */

#ifndef XPUCK_PROXIMITY_DEFAULT_SENSOR_H
#define XPUCK_PROXIMITY_DEFAULT_SENSOR_H

namespace argos {
   class CXPuckProximityDefaultSensor;
}
...
namespace argos {
   ...
   class CXPuckProximityDefaultSensor : public CSimulatedSensor,
                                        public CCI_XPuckProximitySensor {

   public:

      CXPuckProximityDefaultSensor();

      virtual ~CXPuckProximityDefaultSensor() {}
