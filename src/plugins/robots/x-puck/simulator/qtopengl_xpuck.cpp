/**
 * @file <argos3/plugins/robots/x-puck/simulator/qtopengl_xpuck.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "qtopengl_xpuck.h"
...
namespace argos {
   ...
   static const UInt8 XPUCK_COMPONENTS_NUMBER        = 6;

   /****************************************/
   /****************************************/

   CQTOpenGLXPuck::CQTOpenGLXPuck() :
      m_unVertices(40),
      ...
      m_unLists = glGenLists(XPUCK_COMPONENTS_NUMBER);
   ...
   CQTOpenGLXPuck::~CQTOpenGLXPuck() {
      glDeleteLists(m_unLists, XPUCK_COMPONENTS_NUMBER);
   }

   /****************************************/
   /****************************************/

   void CQTOpenGLXPuck::Draw(CXPuckEntity& c_entity) {
      /* Place the chassis */
   ...
   void CQTOpenGLXPuck::SetGreenPlasticMaterial() {
   ...
   void CQTOpenGLXPuck::SetWhitePlasticMaterial() {
   ...
   void CQTOpenGLXPuck::SetGrayPlasticMaterial() {
   ...
   void CQTOpenGLXPuck::SetRedPlasticMaterial() {
   ...
   void CQTOpenGLXPuck::SetCircuitBoardMaterial() {
   ...
   void CQTOpenGLXPuck::SetLEDMaterial(GLfloat f_red,
                                       GLfloat f_green,
                                       GLfloat f_blue) {
   ...
   void CQTOpenGLXPuck::RenderWheel() {
      /* Set material */
   ...
   void CQTOpenGLXPuck::RenderChassis() {
      /* Set material */
   ...
   void CQTOpenGLXPuck::RenderBody() {
      /* Set material */
      SetGreenPlasticMaterial();
...
//      glEnd();
   ...
   void CQTOpenGLXPuck::RenderRGBLED() {
      /* Side surface */
   ...
   void CQTOpenGLXPuck::RenderCamera() {
      /* Set material */
   ...
   class CQTOpenGLOperationDrawXPuckNormal : public CQTOpenGLOperationDrawNormal {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CXPuckEntity& c_entity) {
         static CQTOpenGLXPuck m_cModel;
   ...
   class CQTOpenGLOperationDrawXPuckSelected : public CQTOpenGLOperationDrawSelected {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CXPuckEntity& c_entity) {
   ...
   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawNormal, CQTOpenGLOperationDrawXPuckNormal, CXPuckEntity);

   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawSelected, CQTOpenGLOperationDrawXPuckSelected, CXPuckEntity);
