/**
 * @file <argos3/plugins/robots/x-puck/simulator/xpuck_entity.h>
...
#ifndef XPUCK_ENTITY_H
#define XPUCK_ENTITY_H
...
namespace argos {
   ...
   class CXPuckEntity : public CComposableEntity {
   ...
   public:
      ...
      CXPuckEntity(const std::string& str_id,
      ...
      inline CXpuckRABEquippedEntity& GetRABEquippedEntity() {
   ...
   private:
      ...
      CXpuckRABEquippedEntity*                    m_pcRABEquippedEntity;
