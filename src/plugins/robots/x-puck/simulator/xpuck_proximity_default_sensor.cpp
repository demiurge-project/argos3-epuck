/**
 * @file <argos3/plugins/robots/x-puck/simulator/x-puck_proximity_default_sensor.cpp>
 *
...
#include "xpuck_proximity_default_sensor.h"
...
CXPuckProximityDefaultSensor::CXPuckProximityDefaultSensor() :
...
void CXPuckProximityDefaultSensor::Init(TConfigurationNode& t_tree) {
    try {
        CCI_XPuckProximitySensor::Init(t_tree);
        /* Show rays? */
        ...
        if(fNoiseLevel < 0.0f) {
            THROW_ARGOSEXCEPTION("Can't specify a negative value for the noise level"
                                 << " of the x-puck proximity sensor");
        }
        ...
        THROW_ARGOSEXCEPTION_NESTED("Initialization error in x-puck default proximity sensor", ex);
    }
}
...
void CXPuckProximityDefaultSensor::SetRobot(CComposableEntity& c_entity) {
    try {
        ...
        THROW_ARGOSEXCEPTION_NESTED("Can't set robot for the x-puck proximity default sensor", ex);
    }
}
...
void CXPuckProximityDefaultSensor::Update() {
...
void CXPuckProximityDefaultSensor::Reset() {
...
Real CXPuckProximityDefaultSensor::CalculateReading(Real f_distance) {
    Real value = 0.0f;
    if(f_distance <= 0.05){
...
REGISTER_SENSOR(CXPuckProximityDefaultSensor,
                "xpuck_proximity", "default",
                "Lorenzo Garattoni [lgaratto@ulb.ac.be]",
                "1.0",
                "The x-puck proximity sensor",
                ...
                "For usage, refer to [ci_xpuck_proximity_sensor.h]\n\n"
                ...
                "         <sensors>\n"
                "            ...\n"
                "            <xpuck_proximity implementation=\"default\"/>\n"
                "            ...\n"
                "         <sensors/>\n"
                "         ...\n"
                "      <my_controller/>\n"
                ...
                "         <sensors>\n"
                "            ...\n"
                "            <xpuck_proximity implementation=\"default\" show_rays=\"true\"/>\n"
                "            ...\n"
                "         <sensors/>\n"
                "         ...\n"
                "      <my_controller/>\n"
                ...
                "         <sensors>\n"
                "            ...\n"
                "            <xpuck_proximity implementation=\"default\" noise_level=\"0.1\"/>\n"
                "            ...\n"
                "         <sensors/>\n"
                "         ...\n"
                "      <my_controller/>\n"
