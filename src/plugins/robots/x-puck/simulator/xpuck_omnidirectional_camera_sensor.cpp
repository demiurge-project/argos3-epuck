/**
 * @file <argos3/plugins/robots/x-puck/simulator/xpuck_omnidirectional_camera_sensor.cpp>
 *
 * @author Gianpiero Francesca - <gianpiero.francesca@ulb.ac.be>
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 */
#include "xpuck_omnidirectional_camera_sensor.h"
...
public:
    ...
    CLEDCheckOperation(CCI_XPuckOmnidirectionalCameraSensor::TBlobList& t_blobs,
        ...
        if(c_led.GetColor() != CColor::BLACK) {
            ...
            if(Abs(m_cLEDRelativePos.GetX()) < m_fGroundHalfRange &&
                 ...
                 * has been calculated from empirical data.
                   */
                m_tBlobs.push_back(new CCI_XPuckOmnidirectionalCameraSensor::SBlob(
                                       c_led.GetColor(),
...
private:
    ...
    CCI_XPuckOmnidirectionalCameraSensor::TBlobList& m_tBlobs;
...
CXPuckOmnidirectionalCameraSensor::CXPuckOmnidirectionalCameraSensor() :
    m_bEnabled(false),
...
void CXPuckOmnidirectionalCameraSensor::SetRobot(CComposableEntity& c_entity) {
...
void CXPuckOmnidirectionalCameraSensor::Init(TConfigurationNode& t_tree) {
    try {
        /* Parent class init */
        CCI_XPuckOmnidirectionalCameraSensor::Init(t_tree);
        /* Show rays? */
...
void CXPuckOmnidirectionalCameraSensor::Update() {
    if(m_bEnabled) {
...
void CXPuckOmnidirectionalCameraSensor::Reset() {
...
void CXPuckOmnidirectionalCameraSensor::Destroy() {
...
void CXPuckOmnidirectionalCameraSensor::Enable() {
...
void CXPuckOmnidirectionalCameraSensor::Disable() {
...
REGISTER_SENSOR(CXPuckOmnidirectionalCameraSensor,
                "xpuck_omnidirectional_camera", "rot_z_only",
