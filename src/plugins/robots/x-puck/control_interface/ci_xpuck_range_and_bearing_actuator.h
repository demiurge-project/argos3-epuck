/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_range_and_bearing_actuator.h>
 *
 * @author Gianpiero Francesca <gianpiero.francesca@ulb.ac.be>
 * @author Lorenzo Garattoni <lgaratto@ulb.ac.be>
 */

#ifndef CCI_XPUCK_RANGE_AND_BEARING_ACTUATOR_H
#define CCI_XPUCK_RANGE_AND_BEARING_ACTUATOR_H

namespace argos {
class CCI_XPuckRangeAndBearingActuator;
}
...
class CCI_XPuckRangeAndBearingActuator : public CCI_Actuator {
public:
...
public:
    ...
    virtual ~CCI_XPuckRangeAndBearingActuator() {}
