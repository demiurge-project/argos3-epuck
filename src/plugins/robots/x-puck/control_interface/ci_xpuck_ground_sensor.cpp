/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_ground_sensor.cpp>
 *
 * @author Lorenzo Garattoni- <lgaratto@ulb.ac.be>
 */

#include "ci_xpuck_ground_sensor.h"
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckGroundSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckGroundSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
