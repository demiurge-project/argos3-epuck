/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_light_sensor.h>
 *
 * @brief This file provides the implementation of the xpuck light sensor.
 *
 * This file provides the definition of the xpuck light sensor.
 ...
 * following order (seeing the x-puck from TOP, battery socket is the BACK):
 *
 *              front
 *
 *              0   7
...
#ifndef CCI_XPUCK_LIGHT_SENSOR_H
#define CCI_XPUCK_LIGHT_SENSOR_H

namespace argos {
   class CCI_XPuckLightSensor;
}
...
namespace argos {
   ...
   class CCI_XPuckLightSensor : virtual public CCI_Sensor {
     ...
     public:
       ...
       * Constructor
       */
      CCI_XPuckLightSensor();

      /**
       * Destructor
       */
      virtual ~CCI_XPuckLightSensor() {}
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_XPuckLightSensor::SReading& s_reading);

   /**
    * Redefine the "<<" operator with readings.
    */
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_XPuckLightSensor::TReadings& t_readings);
}
#endif
