/**
 * @file common/control_interface/x-puck/ci_xpuck_micro_sensor.h
 *
 * @brief This file provides the implementation of the xpuck micro sensor.
 *
 * This file provides the definition of the xpuck micro sensor.
 * The sensors are evenly spaced on the left, right and back to the base of the xpuck.
 ...
 */
#ifndef CCI_XPUCK_MICRO_SENSOR_H
#define CCI_XPUCK_MICRO_SENSOR_H

namespace argos {
   class CCI_XPuckMicroSensor;
}
...
namespace argos {
   ...
   class CCI_XPuckMicroSensor : virtual public CCI_Sensor {
     ...
     public:
       ...
       * Constructor
       */
      CCI_XPuckMicroSensor() {
         THROW_ARGOSEXCEPTION("The x-puck micro sensor is not implemented");
      }
