/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_omnidirectional_camera_sensor.cpp
 *
 * @brief This file provides the definition of the x-puck
 * omnidirectional camera sensor.
 *
 *  * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
    * @author Gianpiero Francesca <gianpiero.francesca@ulb.ac.be>
 */
#include "ci_xpuck_omnidirectional_camera_sensor.h"
...
namespace argos {
   ...
   int LuaEnableCamera(lua_State* pt_lua_state) {
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_XPuckOmnidirectionalCameraSensor>(pt_lua_state, "colored_blob_omnidirectional_camera")->Enable();
         return 0;
   }
#endif
   ...
   int LuaDisableCamera(lua_State* pt_lua_state) {
      /* Perform action */
      CLuaUtility::GetDeviceInstance<CCI_XPuckOmnidirectionalCameraSensor>(pt_lua_state, "colored_blob_omnidirectional_camera")->Disable();
         return 0;
   }
#endif
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckOmnidirectionalCameraSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckOmnidirectionalCameraSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   bool CCI_XPuckOmnidirectionalCameraSensor::Enabled() const
   {
       return m_bEnabled;
   }
