/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_range_and_bearing_sensor.h>
 *
...
#ifndef CCI_XPUCK_RANGE_AND_BEARING_SENSOR_H
#define CCI_XPUCK_RANGE_AND_BEARING_SENSOR_H

namespace argos {
   class CCI_XPuckRangeAndBearingSensor;
}
...
namespace argos {
   ...
   class CCI_XPuckRangeAndBearingSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Destructor
       */
      ~CCI_XPuckRangeAndBearingSensor() {}
