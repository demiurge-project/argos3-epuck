/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_ircom_sensor.h
 *
 * @brief This file provides the control interface of the x-puck IR Communication sensor
 *
 * @author Lorenzo Garattoni- <lgaratto@ulb.ac.be>
 */

#ifndef CCI_XPUCK_IRCOM_SENSOR_H
#define CCI_XPUCK_IRCOM_SENSOR_H

namespace argos {
   class CCI_XPuckIRComSensor;
}
...
namespace argos {
   ...
   class CCI_XPuckIRComSensor : public CCI_Sensor {
