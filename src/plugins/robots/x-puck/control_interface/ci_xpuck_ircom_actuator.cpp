/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_ircom_actuator.h
 *
 * @brief This file provides the control interface of the x-puck IR Communication actuator
 *
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 */

#include "ci_xpuck_ircom_actuator.h"
...
namespace argos {
   ...
   int LuaIRComSetData(lua_State* pt_lua_state) {
      if(lua_gettop(pt_lua_state) == 1) {
         ...
         CCI_XPuckIRComActuator* pcAct = CLuaUtility::GetDeviceInstance<CCI_XPuckIRComActuator>(pt_lua_state, "ircom");
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckIRComActuator::CreateLuaState(lua_State* pt_lua_state) {
