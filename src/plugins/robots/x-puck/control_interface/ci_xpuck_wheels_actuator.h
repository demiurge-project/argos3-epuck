 ...
 * of the ropuck, that is the distance covered by the x-puck (in
 ...
 * also used in other related sensors, such as the xpuck wheel
 * speed sensor and the xpuck encoder sensor.
 *
 * @author Lorenzo Garattoni- <lgaratto@ulb.ac.be>
 * @author Carlo Pinciroli - <cpinciro@ulb.ac.be>
 */

#ifndef CCI_XPUCK_WHEELS_ACTUATOR_H
#define CCI_XPUCK_WHEELS_ACTUATOR_H

namespace argos {
   class CCI_XPuckWheelsActuator;
}
...
namespace argos {
   ...
   class CCI_XPuckWheelsActuator : virtual public CCI_Actuator {
