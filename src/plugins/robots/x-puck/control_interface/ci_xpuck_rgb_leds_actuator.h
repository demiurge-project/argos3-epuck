 ...
 *
 * This file provides the definition of the x-puck RGB LEDs actuator.
 *
 * The user can switch on the 3 RGB LEDs on top of the overo extension
 * of the x-puck, specifying the RGB color.
 *
...
#ifndef CCI_XPUCK_RGB_LEDS_ACTUATOR_H
#define CCI_XPUCK_RGB_LEDS_ACTUATOR_H

#include <argos3/core/utility/logging/argos_log.h>

namespace argos {
   class CCI_XPuckRGBLEDsActuator;
}
...
namespace argos {
   ...
   class CCI_XPuckRGBLEDsActuator : public CCI_Actuator {
   ...
   public:
      ...
      CCI_XPuckRGBLEDsActuator();

      virtual ~CCI_XPuckRGBLEDsActuator() {}
