/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_range_and_bearing_sensor.cpp>
 *
 * @author Lorenzo Garattoni- <lgaratto@ulb.ac.be>
 */

#include "ci_xpuck_range_and_bearing_sensor.h"
...
namespace argos {
   ...
   void CCI_XPuckRangeAndBearingSensor::Init(TConfigurationNode& t_node) {
   ...
   void CCI_XPuckRangeAndBearingSensor::ClearPackets() {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckRangeAndBearingSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckRangeAndBearingSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   std::ostream& operator<<(std::ostream& os,
                            const CCI_XPuckRangeAndBearingSensor::SReceivedPacket & t_packet) {
