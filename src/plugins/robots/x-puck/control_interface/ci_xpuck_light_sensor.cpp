/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_light_sensor.cpp>
 *
 * @author Lorenzo Garattoni- <lgaratto@ulb.ac.be>
 */

#include "ci_xpuck_light_sensor.h"
...
namespace argos {
   ...
   CCI_XPuckLightSensor::CCI_XPuckLightSensor() :
      m_tReadings(8) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckLightSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckLightSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
