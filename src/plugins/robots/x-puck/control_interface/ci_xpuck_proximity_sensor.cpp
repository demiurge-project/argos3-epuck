/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_proximity_sensor.cpp>
 *
 * @author Lorenzo Garattoni- <lgaratto@ulb.ac.be>
 */

#include "ci_xpuck_proximity_sensor.h"
...
namespace argos {
   ...
   CCI_XPuckProximitySensor::CCI_XPuckProximitySensor() :
      m_tReadings(8) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckProximitySensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckProximitySensor::ReadingsToLuaState(lua_State* pt_lua_state) {
