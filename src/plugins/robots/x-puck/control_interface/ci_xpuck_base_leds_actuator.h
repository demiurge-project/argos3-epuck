/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_base_leds_actuator.h>
 *
 * @brief This file provides the definition of the x-puck base LEDs actuator.
 *
 * This file provides the definition of the x-puck base LEDs actuator.
...
#ifndef CCI_XPUCK_BASE_LEDS_ACTUATOR_H
#define CCI_XPUCK_BASE_LEDS_ACTUATOR_H

namespace argos {
   class CCI_XPuckBaseLEDsActuator;
}
...
namespace argos {
   ...
   class CCI_XPuckBaseLEDsActuator : public CCI_Actuator {

   public:

      CCI_XPuckBaseLEDsActuator();
      ~CCI_XPuckBaseLEDsActuator() {}
