/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_virtual_camrab_actuator.h>
 *
 * @brief This file provides the definition of the xpuck virtual camrab actuator.
 *
 * This file provides the definition of the xpuck virtual camrab actuator.
...
#ifndef CCI_XPUCK_VIRTUAL_CAMRAB_ACTUATOR_H
#define CCI_XPUCK_VIRTUAL_CAMRAB_ACTUATOR_H

namespace argos {
   class CCI_XPuckVirtualCamrabActuator;
}
...
class CCI_XPuckVirtualCamrabActuator : public CCI_Actuator {
...
public:
     ...
     * Destructor
     */
    virtual ~CCI_XPuckVirtualCamrabActuator(){}
