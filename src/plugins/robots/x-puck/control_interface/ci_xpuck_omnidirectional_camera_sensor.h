/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_omnidirectional_camera_sensor.h
 *
 ...
 */
#ifndef CI_XPUCK_OMNIDIRECTIONAL_CAMERA_SENSOR_H
#define CI_XPUCK_OMNIDIRECTIONAL_CAMERA_SENSOR_H
...
namespace argos {
   ...
   class CCI_XPuckOmnidirectionalCameraSensor: virtual public CCI_Sensor {
   ...
   public:
        ...
        * Constructor
        */
       CCI_XPuckOmnidirectionalCameraSensor():m_bEnabled(true) {
       }

       /**
        * Destructor
        */
       virtual ~CCI_XPuckOmnidirectionalCameraSensor() {
       }
