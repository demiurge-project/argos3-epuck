/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_encoder_sensor.h
 *
 * @brief This file provides the definition of the xpuck encoder sensor.
 *
 * This file provides the definition of the xpuck encoder sensor. It
...
#ifndef CCI_XPUCK_ENCODER_SENSOR_H
#define CCI_XPUCK_ENCODER_SENSOR_H

namespace argos {
   class CCI_XPuckEncoderSensor;
}
...
namespace argos {
   ...
   class CCI_XPuckEncoderSensor : public CCI_Sensor {
   ...
   public:
      ...
      /**
       * Struct to store the datas read by the encoder sensor of the x-puck
       */
      struct SReading {
         /**
       ...
       * Destructor
       */
      virtual ~CCI_XPuckEncoderSensor() {}
