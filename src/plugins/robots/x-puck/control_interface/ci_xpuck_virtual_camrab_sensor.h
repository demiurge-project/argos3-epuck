/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_virtual_camrab_sensor.h>
 *
 * @brief This file provides the definition of the xpuck virtual camrab sensor.
 *
 * This file provides the definition of the xpuck virtual camrab sensor.
...
#ifndef CCI_XPUCK_VIRTUAL_CAMRAB_SENSOR_H
#define CCI_XPUCK_VIRTUAL_CAMRAB_SENSOR_H

namespace argos {
   class CCI_XPuckVirtualCamrabSensor;
}
...
class CCI_XPuckVirtualCamrabSensor : public CCI_Sensor {
...
public:
     ...
     * Destructor
     */
    virtual ~CCI_XPuckVirtualCamrabSensor() {}
...
protected:
     ...
     */
     std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> FilterBlobs(std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> vec_blobs);
     ...
     */
    CCI_XPuckOmnidirectionalCameraSensor::SBlob* MergeBlobs(std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> vec_blobs);

    /** Determines if two blobs correspond to the same robot. */
    bool BelongingToSameRobot(CCI_XPuckOmnidirectionalCameraSensor::SBlob* s_reference_blob, CCI_XPuckOmnidirectionalCameraSensor::SBlob* s_current_blob);
     ...
     */
    std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> GetBlobsWithColor(std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> vec_blobs, UInt8 un_color);
    ...
    Real AverageAngle(std::vector<CCI_XPuckOmnidirectionalCameraSensor::SBlob*> vec_blobs);
