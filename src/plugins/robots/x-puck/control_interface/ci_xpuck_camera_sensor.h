/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_camera_sensor.h
 *
 * @brief This file provides the definition of the x-puck camera
 ...
 *        bullshit. Please rework and sync with new xpuck board. Arne
 *
...
namespace argos {
   ...
   class CCI_XPuckCameraSensor: virtual public CCI_Sensor {
     ...
     public:
       ...
       * Constructor
       */
      CCI_XPuckCameraSensor() {
      }

      /**
       * Destructor
       */
      virtual ~CCI_XPuckCameraSensor() {
      }
