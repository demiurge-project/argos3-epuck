/**
 * @file <argos3/plugins/robots/x-puck/control_interface/xpuck_ground_sensor.h
 *
 * @brief This file provides the interface of the x-puck ground sensor.
 *
 * The ground sensors are an additional part of the x-pucks.  They are
...
#ifndef CCI_XPUCK_GROUND_SENSOR_H
#define CCI_XPUCK_GROUND_SENSOR_H

namespace argos {
   class CCI_XPuckGroundSensor;
}
...
namespace argos {
   ...
   class CCI_XPuckGroundSensor : public CCI_Sensor {
