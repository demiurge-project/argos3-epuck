/**
 * @brief This file provides the control interface of the x-puck accelerometer sensor.
 *
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_accelerometer_sensor.h
 *
 * @author Lorenzo Garattoni- <lgaratto@ulb.ac.be>
 */
#ifndef CCI_XPUCK_ACCELEROMETER_SENSOR_H
#define CCI_XPUCK_ACCELEROMETER_SENSOR_H

namespace argos {
   class CCI_XPuckAccelerometerSensor;
}
...
namespace argos {
   ...
   class CCI_XPuckAccelerometerSensor : virtual public CCI_Sensor {
   ...
   public:
       ...
       * Constructor
       */
      CCI_XPuckAccelerometerSensor() {
         THROW_ARGOSEXCEPTION("The x-puck accelerometer sensor is not implemented");
      }

      /**
       * Destructor
       */
      virtual ~CCI_XPuckAccelerometerSensor() {}
