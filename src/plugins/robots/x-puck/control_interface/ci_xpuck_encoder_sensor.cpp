/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_encoder_sensor.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "ci_xpuck_encoder_sensor.h"
...
namespace argos {
   ...
   const Real CCI_XPuckEncoderSensor::WHEEL_AXIS_LENGTH = 0.053f;

   /****************************************/
   /****************************************/

#ifdef ARGOS_WITH_LUA
   void CCI_XPuckEncoderSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_XPuckEncoderSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
