/**
 * @file argos3/plugins/robots/x-puck/real_robots/real_xpuck_wheels_actuator.cpp
 *
 * @author Carlo Pinciroli - <cpinciro@ulb.ac.be>
 */

#include "real_xpuck_wheels_actuator.h"
...
namespace argos {
   ...
   void CRealXPuckWheelsActuator::SetLinearVelocity(Real f_left_velocity,
