/**
 * @file <argos3/plugins/robots/x-puck/real_robot/real_xpuck_ground_sensor.cpp>
 *
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 */

#include "real_xpuck_ground_sensor.h"
...
namespace argos {
   ...
   CRealXPuckGroundSensor::CRealXPuckGroundSensor():
   ...
   void CRealXPuckGroundSensor::Init(TConfigurationNode& t_node) {
      try {
   ...
   void CRealXPuckGroundSensor::Calibrate() {
      try {
   ...
   void CRealXPuckGroundSensor::ReceiveData() {
