/**
 * @file <argos3/plugins/robots/x-puck/control_interface/ci_xpuck_wheels_actuator.h>
 *
 * @brief This file provides the definition of the xpuck wheels actuator.
 *
 * This file provides the definition of the xpuck wheels actuator.
 * This actuator sets the speed of the wheels. On the real x-puck, the
 ...
 * sensors, such as the xpuck wheel speed sensor and the xpuck encoder
 * sensor.
 *
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 */

#ifndef REAL_XPUCK_WHEELS_ACTUATOR_H
#define REAL_XPUCK_WHEELS_ACTUATOR_H

namespace argos {
   class CRealXPuckWheelsActuator;
}
...
namespace argos {
   ...
   class CRealXPuckWheelsActuator : virtual public CCI_XPuckWheelsActuator,
                                    virtual public CRealXPuckSerialActuator {

   public:

      virtual ~CRealXPuckWheelsActuator() {
      }
