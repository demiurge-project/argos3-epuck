/**
 * @file <argos3/plugins/robots/x-puck/real_robot/real_xpuck_i2c_device.h>
 *
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 * @author Carlo Pinciroli <cpinciro@ulb.ac.be>
 */

#ifndef REAL_XPUCK_I2C_DEVICE_H
#define REAL_XPUCK_I2C_DEVICE_H
...
namespace argos {
   ...
   class CRealXPuckI2CDevice {

   public:

      virtual ~CRealXPuckI2CDevice() {}
