/**
 * @file <argos3/plugins/robots/x-puck/real_robot/real_xpuck_micro_sensor.cpp>
 *
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 * @author Matteo Amaducci <matteo.amaducci2@studio.unibo.it>
 */

#include "real_xpuck_micro_sensor.h"
#include <argos3/core/utility/logging/argos_log.h>

static const std::string CONFIGURATION_FILE = "/home/root/ARGoS/low_level_configuration/xpuck_calibration.xml";
...
namespace argos {
   ...
   CRealXPuckMicroSensor::CRealXPuckMicroSensor():
   ...
   void CRealXPuckMicroSensor::Init(TConfigurationNode& t_node) {
      try {
   ...
   void CRealXPuckMicroSensor::UpdateValues() {
      if (m_bCalibrated) {
   ...
   void CRealXPuckMicroSensor::Calibrate() {
   }
