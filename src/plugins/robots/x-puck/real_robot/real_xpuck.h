/**
 * @file <argos3/plugins/robots/x-puck/real_robot/real_xpuck.h>
 *
...
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_proximity_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_battery_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_light_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_ground_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_accelerometer_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_range_and_bearing_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_ircom_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_micro_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_wheels_actuator.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_base_leds_actuator.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_rgb_leds_actuator.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_range_and_bearing_actuator.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_ircom_actuator.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_omnidirectional_camera_sensor.h>
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_virtual_camrab_sensor.h>   //@antoine
#include <argos3/plugins/robots/x-puck/real_robot/real_xpuck_virtual_camrab_actuator.h>   //@antoine
...
namespace argos {
   ...
   protected:
      ...
      CRealXPuck(const CRealXPuck& c_xpuck) {}

      CRealXPuck& operator=(const CRealXPuck& c_xpuck) { return *this; }

   public:
      bool m_bGoHome;
       /**
       * Returns the instance to the CRealXPuck class Since CRealXPuck
       * is a singleton, the instance is created at the first call of
       * this function and returned thereafter.
       *
       * @return The instance to the CRealXPuck class.
       */
      static CRealXPuck& GetInstance();

      /**
       * Class destructor, ensure free/clean/reset of all stuff in x-puck
       */
      virtual ~CRealXPuck();
      ...
      /**
       * Initializes the x-puck state (sensors/actuator and params)
       *
      ...
      */
       ...
       * Insert a new Sensor
       *
       * @param str_sensor_type the type of the sensor ("xpuck_light"
       * for example)
       */
      virtual CCI_Sensor* InsertSensor(const std::string& str_sensor_type);

      /**
       * Get the controller of this x-puck
       *
   ...
   private:
       ...
       */
      std::vector<CRealXPuckSerialSensor*> m_vecSerialSensors;

      /**
       * List of sensors that communicate to the rest of the robot through I2C communication.
       */
      std::vector<CRealXPuckI2CSensor*> m_vecI2CSensors;

      /**
       * Omnidirectional camera sensor
       */
      CRealXPuckOmnidirectionalCameraSensor* m_pcOmnidirectionalCameraSensor;

      /**
       * List of actuators that communicate to the rest of the robot through I2C communication.
       */
      std::vector<CRealXPuckI2CActuator*> m_vecI2CActuators;
