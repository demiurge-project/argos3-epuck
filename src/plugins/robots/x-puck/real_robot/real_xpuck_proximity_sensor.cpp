/**
 * @file <argos3/plugins/robots/x-puck/real_robot/real_xpuck_proximity_sensor.cpp>
 *
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 * @author Matteo Amaducci <matteo.amaducci2@studio.unibo.it>
 */

#include "real_xpuck_proximity_sensor.h"
...
namespace argos {
   ...
   CRealXPuckProximitySensor::CRealXPuckProximitySensor():
   ...
   void CRealXPuckProximitySensor::UpdateValues() {
      if (m_bCalibrated) {
   ...
   void CRealXPuckProximitySensor::Init(TConfigurationNode& t_node) {
   ...
   void CRealXPuckProximitySensor::Calibrate(const std::string& str_conf_file) {
      try {
