...
CRealXPuckOmnidirectionalCameraSensor::CRealXPuckOmnidirectionalCameraSensor() :
    CCI_XPuckOmnidirectionalCameraSensor(),
...
/****************************************/
/****************************************/
void CRealXPuckOmnidirectionalCameraSensor::cleanBlobs(){
...
/****************************************/
/****************************************/
void CRealXPuckOmnidirectionalCameraSensor::Update(){
    if(m_bEnabled){
...
CCI_XPuckOmnidirectionalCameraSensor::SBlob* CRealXPuckOmnidirectionalCameraSensor::convertBlob(CColor& color,CBlobDetector::SBlob& in_blob){
...
/****************************************/
/****************************************/
void CRealXPuckOmnidirectionalCameraSensor::Init(TConfigurationNode& t_tree){
     ...
     */
    m_pcImageGrabber = new CXPuckImageGrabber;
...
void* CRealXPuckOmnidirectionalCameraSensor::StartThread(void* pt_arg) {
    reinterpret_cast<CRealXPuckOmnidirectionalCameraSensor*>(pt_arg)->BlobFetcherThread();
    return NULL;
}
/****************************************/
/****************************************/
...
/****************************************/
/****************************************/
void CRealXPuckOmnidirectionalCameraSensor::BlobFetcherThread() {
