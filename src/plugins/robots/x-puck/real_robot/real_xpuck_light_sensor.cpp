/**
 * @file <argos3/plugins/robots/real_robot/real_xpuck_light_sensor.cpp>
 *
 * @author Lorenzo Garattoni - <lgaratto@ulb.ac.be>
 * @author Matteo Amaducci <matteo.amaducci2@studio.unibo.it>
 */

#include "real_xpuck_light_sensor.h"
...
namespace argos {
   ...
   CRealXPuckLightSensor::CRealXPuckLightSensor():
   ...
   void CRealXPuckLightSensor::UpdateValues() {
   ...
   void CRealXPuckLightSensor::Init(TConfigurationNode& t_node) {
      try {
   ...
   void CRealXPuckLightSensor::Calibrate() {
      try {
