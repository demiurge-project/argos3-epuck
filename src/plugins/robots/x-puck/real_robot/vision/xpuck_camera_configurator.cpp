#include "xpuck_camera_configurator.h"
...
CXPuckCameraConfigurator::CXPuckCameraConfigurator(const std::string& str_conf_file) :
...
CXPuckCameraConfigurator::~CXPuckCameraConfigurator() {
...
void CXPuckCameraConfigurator::Execute() {
...
void CXPuckCameraConfigurator::CommandLoop() {
    UInt8 unCommand;
    while(1) {
        try {
            /* Receive command */
...
void CXPuckCameraConfigurator::ExecuteCommand(UInt8 un_command) {
    switch(un_command) {
...
void CXPuckCameraConfigurator::GetAttributes() {
    try {
        /*
...
void CXPuckCameraConfigurator::SetAttributes() {
    try {
        /*
          * Receive the data
          */
...
void CXPuckCameraConfigurator::Refresh() {
...
void CXPuckCameraConfigurator::SaveConfiguration() {
    try {
...
int main(int n_argc, char** pch_argv) {
    ...
    try {
        argos::CXPuckCameraConfigurator cECC(pch_argv[1]);
        cECC.Execute();
    }
