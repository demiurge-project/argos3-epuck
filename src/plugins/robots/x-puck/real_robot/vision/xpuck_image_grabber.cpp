...
const std::string CONFIGURATION_TAG              = "x-puck";
...
CXPuckImageGrabber::CXPuckImageGrabber() :
    m_unImageWidth(352),
    m_unImageHeight(288),
    m_nDeviceFile(-1),
...
void CXPuckImageGrabber::Init(TConfigurationNode& t_tree) {
...
void CXPuckImageGrabber::Destroy() {
...
void CXPuckImageGrabber::SaveXMLConfiguration(const std::string& str_path) {
    /*
...
void CXPuckImageGrabber::GrabFrame(CImage<SHSV888Pixel>& c_image) {
...
size_t CXPuckImageGrabber::GetImageWidth() const {
...
size_t CXPuckImageGrabber::GetImageHeight() const {
...
void CXPuckImageGrabber::V4LInit() {
...
void CXPuckImageGrabber::V4LDestroy() {
    /* Stop capturing */
    v4l2_buf_type tType = V4L2_BUF_TYPE_VIDEO_CAPTURE;
    if(XIOCTL(m_nDeviceFile,
              VIDIOC_STREAMOFF,
...
void CXPuckImageGrabber::V4LGrabFrame(CImage<SHSV888Pixel>& c_image) {
...
void CXPuckImageGrabber::SetGain(UInt32 un_gain) {
...
void CXPuckImageGrabber::SetExposure(UInt32 un_exposure) {

    m_unImageExposure = un_exposure;
    /*The camera of the xpuck does not support the set of the exposure.
