#ifndef XPUCK_IMAGE_GRABBER_H
#define XPUCK_IMAGE_GRABBER_H

#include <argos3/plugins/robots/x-puck/real_robot/vision/image_grabber.h>
#include <argos3/core/utility/logging/argos_log.h>
#include <argos3/core/utility/math/vector2.h>

namespace argos {

class CXPuckImageGrabber : public CImageGrabber {

public:

    CXPuckImageGrabber();
    virtual ~CXPuckImageGrabber() {}
