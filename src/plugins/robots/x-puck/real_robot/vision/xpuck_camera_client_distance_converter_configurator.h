#ifndef XPUCK_CAMERA_CLIENT_DISTANCE_CONVERTER_CONFIGURATOR_H
#define XPUCK_CAMERA_CLIENT_DISTANCE_CONVERTER_CONFIGURATOR_H
...
namespace argos {
   class CXPuckCameraClientDistanceConverterConfigurator : public QWidget {

      Q_OBJECT

   public:

      CXPuckCameraClientDistanceConverterConfigurator(QWidget* pc_parent);
      virtual ~CXPuckCameraClientDistanceConverterConfigurator() {}
