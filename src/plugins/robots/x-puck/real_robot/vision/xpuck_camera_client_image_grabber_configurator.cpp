...
namespace argos {
   ...
   CXPuckCameraClientImageGrabberImageWidget::CXPuckCameraClientImageGrabberImageWidget(QWidget* pc_parent) :
      QLabel(pc_parent) {
   }
   ...
   void CXPuckCameraClientImageGrabberImageWidget::SetImage(const CByteArray& c_hsv_data) {
   ...
   void CXPuckCameraClientImageGrabberImageWidget::mousePressEvent(QMouseEvent* pc_event) {
   ...
   void CXPuckCameraClientImageGrabberImageWidget::paintEvent(QPaintEvent* pc_event) {
   ...
   void CXPuckCameraClientImageGrabberImageWidget::SetImageWidth(int n_width) {
   ...
   void CXPuckCameraClientImageGrabberImageWidget::SetImageHeight(int n_height) {
   ...
   void CXPuckCameraClientImageGrabberImageWidget::SetImageCenterX(int n_center_x) {
   ...
   void CXPuckCameraClientImageGrabberImageWidget::SetImageCenterY(int n_center_y) {
   ...
   void CXPuckCameraClientImageGrabberImageWidget::SetImageRadius(int n_radius) {
   ...
   CXPuckCameraClientImageGrabberConfigurator::CXPuckCameraClientImageGrabberConfigurator(QWidget* pc_parent) :
      QWidget(pc_parent) {
      /*
       * Create the elements of the widget
       */
      /* Create the image widget */
      m_pcImageDisplay = new CXPuckCameraClientImageGrabberImageWidget();
      /* Create the labels */
   ...
   void CXPuckCameraClientImageGrabberConfigurator::SetImageData(CByteArray& c_data) {
   ...
   void CXPuckCameraClientImageGrabberConfigurator::SetImageWidth(UInt32 un_width) {
   ...
   void CXPuckCameraClientImageGrabberConfigurator::SetImageHeight(UInt32 un_height) {
