#ifndef XPUCK_CAMERA_CLIENT_IMAGE_GRABBER_CONFIGURATOR_H
#define XPUCK_CAMERA_CLIENT_IMAGE_GRABBER_CONFIGURATOR_H
...
namespace argos {
   ...
   class CXPuckCameraClientImageGrabberImageWidget : public QLabel {

      Q_OBJECT

   public:

      CXPuckCameraClientImageGrabberImageWidget(QWidget* pc_parent = 0);

      virtual ~CXPuckCameraClientImageGrabberImageWidget() {}
   ...
   class CXPuckCameraClientImageGrabberConfigurator : public QWidget {

      Q_OBJECT

   public:

      CXPuckCameraClientImageGrabberConfigurator(QWidget* pc_parent);
      virtual ~CXPuckCameraClientImageGrabberConfigurator() {}
   ...
   private:
      ...
      CXPuckCameraClientImageGrabberImageWidget* m_pcImageDisplay;
