#ifndef XPUCK_CAMERA_CLIENT_BLOB_DETECTOR_CONFIGURATOR
#define XPUCK_CAMERA_CLIENT_BLOB_DETECTOR_CONFIGURATOR
...
class MyLabel;
   ...
   class CXPuckCameraClientBlobDetectorConfiguratorTab : public QWidget {

      Q_OBJECT

   public:

      CXPuckCameraClientBlobDetectorConfiguratorTab(QWidget* pc_parent = 0);
      virtual ~CXPuckCameraClientBlobDetectorConfiguratorTab();
   ...
   class CXPuckCameraClientBlobDetectorConfigurator : public QTabWidget {
   ...
   public:
      ...
      CXPuckCameraClientBlobDetectorConfigurator(QWidget* pc_parent = 0);
      virtual ~CXPuckCameraClientBlobDetectorConfigurator() {}

      inline CXPuckCameraClientBlobDetectorConfiguratorTab* GetDetector(size_t un_detector) {
         return dynamic_cast<CXPuckCameraClientBlobDetectorConfiguratorTab*>(widget(un_detector));
      }

      inline void AddDetector(CXPuckCameraClientBlobDetectorConfiguratorTab* pc_detector) {
