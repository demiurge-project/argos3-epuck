...
#include "xpuck_camera_client_blob_detector_configurator.h"
#include "image.h"
#include <QBitmap>
#include <QDebug>
#include <QGroupBox>
...
CXPuckCameraClientBlobDetectorConfiguratorTab::CXPuckCameraClientBlobDetectorConfiguratorTab(QWidget* pc_parent) :
    QWidget(pc_parent),
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::enableColorHandler(int state){
    if(state == Qt::Checked){
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::setPause(bool p){
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::realImageStateHandler(int state){
    if(state == Qt::Checked){
        m_bShowRealImage = true;
    } else {
...
/****************************************/
/****************************************/
void CXPuckCameraClientBlobDetectorConfiguratorTab::eyeDropperHandler(){
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::updateEyeDropperRange(int value){
...
bool CXPuckCameraClientBlobDetectorConfiguratorTab::ColorEnabled() const
{
    return m_bColorEnabled;
}

void CXPuckCameraClientBlobDetectorConfiguratorTab::setColorEnabled(bool bColorEnabled)
{
    if(bColorEnabled){
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::labelClicked(QPoint point) {
...
/****************************************/
/****************************************/
void CXPuckCameraClientBlobDetectorConfiguratorTab::checkSlidersMin(){
...
/****************************************/
/****************************************/
void CXPuckCameraClientBlobDetectorConfiguratorTab::checkSlidersMax(){
...
/****************************************/
/****************************************/
CXPuckCameraClientBlobDetectorConfiguratorTab::~CXPuckCameraClientBlobDetectorConfiguratorTab() {
}

/****************************************/
/****************************************/

void CXPuckCameraClientBlobDetectorConfiguratorTab::SetRealImageData(CByteArray& c_hsv_data){
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::SetImagesData(CByteArray& c_real_image,const UInt8* un_color_filter_image_data,size_t un_color_filter_image_size) {
    if(m_bShowRealImage){
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::SetPixelFilterData(const UInt8* un_data,
                                                                       size_t un_size) {
    if(m_bShowRealImage){
        return;
    }
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::AddBlobData(UInt32 un_center_i,
                                                                UInt32 un_center_j,
                                                                UInt32 un_area) {
...
void CXPuckCameraClientBlobDetectorConfiguratorTab::ClearBlobData() {
    console->clear();
    blob_index=0;
}
...
CXPuckCameraClientBlobDetectorConfigurator::CXPuckCameraClientBlobDetectorConfigurator(QWidget* pc_parent) :
