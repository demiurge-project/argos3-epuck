...
namespace argos {
   ...
   CXPuckCameraClientDistanceConverterConfigurator::CXPuckCameraClientDistanceConverterConfigurator(QWidget* pc_parent) :
      QWidget(pc_parent) {
    ...
    void CXPuckCameraClientDistanceConverterConfigurator::ComputeVariables() {
    ...
    void CXPuckCameraClientDistanceConverterConfigurator::ResetVariables() {
