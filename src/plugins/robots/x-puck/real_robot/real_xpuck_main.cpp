/**
 * @file <argos3/plugins/robots/x-puck/real_robot/real_xpuck_main.cpp>
 *
...
int main(int argc, char** argv) {
     ...
     * Init the x-puck
     */
    CRealXPuck* pcRealXPuck;
    try{
        pcRealXPuck = &CRealXPuck::GetInstance();
        pcRealXPuck->Init(strConfigFileName, strControllerId);
    } catch (CARGoSException& ex) {
